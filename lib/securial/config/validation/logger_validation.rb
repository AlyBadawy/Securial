    ...
    module Validation
      class LoggerValidation
        ...
        def self.validate!(config)
          allowed_options = {
            log_to_file: [config.log_to_file, [true, false], "boolean"],
            log_to_stdout: [config.log_to_stdout, [true, false], "boolean"],
            log_file_level: [config.log_file_level, LEVELS, "symbol"],
            log_stdout_level: [config.log_stdout_level, LEVELS, "symbol"],
          }
