...
- Change location of the Securial custom errors to be in `lib/errors/` instead of `app/errors/securial`
...
- Unreleased: https://github.com/AlyBadawy/Securial/compare/v0.4.1...main
